...
const CartIcon = ({ toggleCartHidden, itemCount }) => ( // here this name is the same as the one in mapDispatchToProps before : and in onClick because these are the props 
